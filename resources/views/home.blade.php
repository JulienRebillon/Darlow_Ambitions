            ...
            <div class="flex bg-black">
                ...
                <nav role="navigation">
                    <div id="menuToggle" class="block relative top-50 left-50 z-1 ">
                      ...
                      -->
                      <span class="bg-white block w-[33] h-[4] mb-5 relative rounded z-1"></span>
                      <span class="bg-white block w-[33] h-[4] mb-5 relative rounded z-1"></span>
                      <span class="bg-white block w-[33] h-[4] mb-5 relative rounded z-1"></span>
                      ...
                      -->
                        <ul id="menu" class="flex flex-col items-center">
                            ...
                            <a href="{{ route('apropos') }}"><li class="my-3 text-white">A propos</li></a>
                            <a href="{{ route('tarifs') }}"><li class="my-3 text-white">Tarifs</li></a>
                            <a href="{{ route('blog') }}"><li class="my-3 text-white">Blog</li></a>
                            <a href="{{ route('avis') }}"><li class="my-3 text-white">Avis</li></a>
                            <a href="{{ route('contact') }}"><li class="my-3 text-white">Contact</li></a>
                            <div class="flex">
                ...
                <div class="flex hidden">
                    <a href="{{ route('apropos') }}" class="text-white">A propos<br/>
                    <div class=" w-2 h-2 rounded bg-black-900 hover:bg-red-700"></div></a>

                    <a href="{{ route('tarifs') }}" class="text-white">Tarifs<br/>
                        <div class=" w-2 h-2 rounded bg-black-900 hover:bg-red-700"></div></a>

                    <a href="{{ route('blog') }}" class="text-white">Blog<br/>
                        <div class=" w-2 h-2 rounded bg-black-900 hover:bg-red-700"></div></a>
                    
                    <a href="{{ route('avis') }}" class="text-white">Avis<br/>
                        <div class=" w-2 h-2 rounded bg-black-900 hover:bg-red-700"></div></a>

                    <a href="{{ route('contact') }}" class="text-white">contact<br/>
                        <div class=" w-2 h-2 rounded bg-black-900 hover:bg-red-700"></div></a>
